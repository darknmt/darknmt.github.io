...
The estimates of higher derivatives of \(F\) will be established in the following order: first in \(W^{2,p}\) for all \(p\) norm then in \(W^{k,p}\) for all \(k,p\), then in \(C^\infty\).
