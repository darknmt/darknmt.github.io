...
are Banach and the diagram in Figure ref:fig:interpol-pair commutes and the arrows are
...
#+HEADER: :results raw  :file ../img/2018-05-01-interpol-pair.png
#+HEADER: :packages '(("" "tikz-cd"))
#+HEADER: :exports (if (eq org-export-current-backend 'html) "none" "code")
#+BEGIN_SRC latex 
\begin{tikzcd}
0 \arrow[r] & A_0\cap A_1 \arrow[r] & A_0\oplus A_1 \arrow[r] & A_0+A_1 \arrow[r] & 0
\end{tikzcd}
%\caption{}
...
#+RESULTS:
[[file:../img/2018-05-01-interpol-pair.png]]

#+HTML: <div id=fig:interpol-pair class="figure-ref">#REF: fig:interpol-pair</div>
#+CAPTION:  
#+ATTR_HTML: :width 50%
...
\) and \( A+B \)) and the diagram in Figure
ref:fig:unique-interpol-pair in which 
...
#+HEADER: :imagemagick yes :iminoptions -density 300 -resize 1000 :buffer no :fit yes
#+HEADER: :results raw  :file ../img/2018-05-01-unique-interpol-pair.png
#+HEADER: :packages '(("" "tikz-cd"))
#+HEADER: :exports (if (eq org-export-current-backend 'html) "none" "code")
#+BEGIN_SRC latex 
\begin{tikzcd}
 &  & 0 \arrow[d, bend right] &  &  \\
 &  & A_0 \arrow[u, bend right] \arrow[d, bend right] \arrow[rd] &  &  \\
0 \arrow[r] & U \arrow[r] \arrow[rd] \arrow[ru] & A_0\oplus A_1 \arrow[r] \arrow[u, bend right] \arrow[d, bend right] & V \arrow[r] & 0 \\
 &  & A_1 \arrow[u, bend right] \arrow[d, bend right] \arrow[ru] &  &  \\
 &  & 0 \arrow[u, bend right] &  & 
\end{tikzcd}
%\caption{The data of interpolatable pair is uniquely defined by this diagram.}
\label{fig:unique-interpol-pair}
#+END_SRC

#+RESULTS:
[[file:../img/2018-05-01-unique-interpol-pair.png]]

#+HTML: <div id=fig:unique-interpol-pair class="figure-ref">#REF: fig:unique-interpol-pair</div>
#+CAPTION: The data of interpolatable pair is uniquely defined by this diagram.
#+ATTR_HTML: :width 50%
#+ATTR_LATEX: :width 0.50\textwidth
file:../img/2018-05-01-unique-interpol-pair.png
...
#+BEGIN_EXPORT latex
\begin{tikzcd}
0 \arrow[r] & A_0\cap A_1 \arrow[r] \arrow[d, "T"] & A_0\oplus A_1 \arrow[r] \arrow[d, "T\oplus T"] & A_0+A_1 \arrow[r] \arrow[d, "T"] & 0 \\
0 \arrow[r] & B_0\cap B_1 \arrow[r] & B_0\oplus B_1 \arrow[r] & B_0 + B_1 \arrow[r] & 0
\end{tikzcd}
#+END_EXPORT
...
#+BEGIN_EXPORT latex
\begin{tikzcd}
X_\theta \arrow[r] & Y_\theta \\
\mathcal{H}(X_0,X_1)/\mathcal{K}_\theta(X_0,X_1) \arrow[u, "\cong" description] & \mathcal{H}(Y_0,Y_1)/\mathcal{K}_\theta(Y_0, Y_1) \arrow[u, "\cong" description] \\
\mathcal{H}(X_0,X_1) \arrow[u, two heads] \arrow[r] & \mathcal{H}(Y_0,Y_1) \arrow[u, two heads]
\end{tikzcd}
#+END_EXPORT
...
#+ATTR_HTML: :width 50%
#+ATTR_LATEX: :width 0.50\textwidth
[[file:../img/2018-05-02-interp-closed-emb.png]]
#+LATEX: \fi
...
#+BEGIN_EXPORT latex
\begin{tikzcd}
0 \arrow[r] & X_0\cap X_1 \arrow[r] \arrow[d] & X_0\oplus X_1 \arrow[r] \arrow[d] & X_0+X_1 \arrow[r] \arrow[d] & 0 \\
0 \arrow[r] & Y_0\cap Y_1 \arrow[r] & Y_0\oplus Y_1 \arrow[r] & Y_0+Y_1 \arrow[r] & 0
\end{tikzcd}
#+END_EXPORT
...
#+ATTR_HTML: :width 50%
#+ATTR_LATEX: :width 0.50\textwidth 
[[file:../img/2018-05-02-closed-sum.png]]
#+LATEX: \fi
...
2. For the case of small \( k \), note that 
   ...
   #+BEGIN_EXPORT latex
   \begin{tikzcd}
   W^{k+r,p}(X) \arrow[r, two heads] \arrow[d, "\rm compact"', hook] & W^{k,p}(X) \arrow[d, hook] \\
   W^{h+r,p}(X) \arrow[r, two heads] & W^{h,p}(X)
   \end{tikzcd}
   %\caption{Insert caption}
   \label{fig:kondrachov-diag}
   #+END_EXPORT
   
   #+LATEX:\iffalse
   #+ATTR_HTML: :width 30%
   [[file:../img/2018-05-02-kondrachov-diag.png]]
   #+LATEX:\fi
