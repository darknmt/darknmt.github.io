...
3. \( {\rm Riem}\geq 0 \) (resp. \( {\rm Riem} > 0 \)) if all sectional curvature is
   positive, i.e. \(R_{ijhk} u_1^i v_1^j
   u_2^h v_2^k\) is positive for non-colinear vectors \( u,v \).
...
- \( R'_{\alpha\beta\gamma\delta} f^\alpha_i f^\beta_j f^\gamma_k f^\delta_l
   g^{ik}g^{jl} \) is \( \tilde
  R'\otimes g\otimes g \) applied to \( (f_i^\alpha \tilde e_\alpha\otimes dx^i,f_i^\alpha
  \tilde e_\alpha\otimes dx^i) \) where \( \tilde R' \) is defined by \(\tilde R': ((u_1,v_1),(u_2,v_2)) \mapsto R'_{ijhk} u_1^i v_1^j
   u_2^h v_2^k\).
