...
3. \( {\rm Riem}\geq 0 \) (resp. \( {\rm Riem} > 0 \)) if the symmetric bilinear form
   \(\tilde R: ((u_1,v_1),(u_2,v_2)) \mapsto R_{ijhk} u_1^i v_1^j
   u_2^h v_2^k\) is positive (resp. semi-positive) at \( P\in M \).
...
1. If \( f \) is harmonic and \( Q(f_*) \geq 0 \) then \( f \) is totally geodesic and \(
   e(f) \) is constant.
2. If \( {\rm Ric}(M) \leq 0 \) and \( {\rm Riem}(M')\geq 0 \) then \( f \) is harmonic if
...
- \( R'_{\alpha\beta\gamma\delta}f^\gamma_k f^\delta_l g^{ik}g^{jl} \) is \( \tilde
  R'\otimes g\otimes g \) applied to \( (f_i^\alpha \tilde e_\alpha\otimes dx^i,f_i^\alpha \tilde e_\alpha\otimes dx^i) \) where \( \tilde R' \) is the bilinear form \(\tilde R': ((u_1,v_1),(u_2,v_2)) \mapsto R'_{ijhk} u_1^i v_1^j
   u_2^h v_2^k\).
