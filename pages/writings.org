...
* Another formula for \( \Enorm\). Harmonic maps are critical points of \( \Enorm \) in case of stronger vanishing condition.
...
\). They then 
- use Gauss--Codazzi formula and Einstein equation to rewrite \( 1+K \) in term of
...
** Critical points of \( \mathcal{E}_{\text norm} \)
...
* Existence and invariance by special bdf of the renormalised energy. label:existence-enorm
