...
#Point = (pos, theta, ID)
def expandByFieldNonEV(point, arrAngleField, arrHistory, arrHasValue, dequeue, N, sqrPoint=[0,0], sqrSide=1):
    #Where am I
    pos, theta, ID = point
    a = sqrSide*1.0/N
...
while dequeue:
    ...
    res = expandByFieldNonEV(currentPoint, arrAngleField, arrHistory, arrHasValue, dequeue, N, sqrPoint=[-2,-2], sqrSide=4)
    print res
    if res != None:
        dequeue.append(res)
